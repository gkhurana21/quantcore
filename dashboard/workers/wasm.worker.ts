// Web Worker for Monte Carlo on the WebAssembly build of the C++ core — one contract or a
// whole portfolio — so a multi-million-path run never blocks the page. The module loads once
// per worker.
